from transformers import AutoTokenizer, AutoModelForSequenceClassification, Trainer, TrainingArguments, set_seed, get_linear_schedule_with_warmup
import evaluate
import torch
import os
import numpy as np
...
targs = TrainingArguments(
    output_dir = os.path.join(path, 'finetuning/final-llama-on-pythia-2'),
